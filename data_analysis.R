# Code Description -------------------------------------------------------
# This script replicates the results of the paper： Climate-induced Citizen Noncompliance May Undermine State Capacity in Africa
...
# Baseline Models: extreme as dummy -------------------------------------------------------------
...
# require approval from Afrobarometer and therefore will not be included in the replication package. 
